...
class Product extends Page {
	...
	private static $has_one=array(
		'PlaceHolderProductImage'=>'PageImage',
		'ProductThumbnailImage' =>'PageImage',
		'MainProductImage' =>'PageImage',
	...
	public function getCMSFields() {
		...
		//Product fields
		//$fields->addFieldToTab('Root.Main', new UploadField($name ='MainProductImage',$title = 'Main Product Image'),'Content');
        ...
        $fields->addFieldToTab('Root.Main', new UploadField($name ='ProductThumbnailImage',$title = 'Product Thumbnail Image to be display on recipe page'),'Content');
        ...
        #$fields->addFieldToTab('Root.Main', new UploadField($name ='PlaceHolderProductImage',$title = 'Image Display on product Category Page'),'Content');
         ...
         $fields->addFieldToTab(
            ...
            $uploadField = new UploadField(
                $name = 'ProductImages',
                $title = 'Upload one or more rpoduct images (max 3 in total)'
            )   
        );
        $uploadField->setConfig('allowedMaxFileNumber', 3);
        ...
        $fields->addFieldToTab("Root.ProductDescription", HTMLEditorField::create("NutritionalInformationPanel", "Nutritional Information Panel"));
		...
		$boxes = new checkboxfield("DisplayAsFeatureProduct");

		
        $fields->addFieldToTab('Root.Main', $boxes);
...
class Product_Controller extends Page_Controller {
	...
	public function init() {
		...
		Requirements::css('onlineshopping/css/Shop.css');
