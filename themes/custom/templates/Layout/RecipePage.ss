...
<div class="container">
    ...
    <div class="row col-md-12">
         <div class="col-md-6" style="margin-bottom:30px;" >
               ...
               <a  href="$Link"> <img id="" src="$ReceipePageImage.CroppedImage(500,500).URL" class="img-fluid" alt=""></a>
          </div>
          <div class="col-md-6 " style="margin-bottom:30px; border-bottom: 1px solid black; border-bottom-color: #ab9271;">
                  ...
                  <hr class="producePage"/>
                  <div class="row col-md-12" style="margin-left:-45px;">
                       <% if $Box1 %>
                              <div class="col-md-3" >
                                  <div class="col-md-12" >
                      ...
                      <% end_if %>
                       <div class="col-md-3" >
                           <!--<productTitle2>RATE THIS RECIPE:</productTitle2>ml-auto mr-4 ml-1-->
                       </div>
              ...
              <div class="row col-md-12"  style="margin-right:1px !important; margin-left:1px !important;">
                  ...
                  <div class="col-md-3 col-sm-12" style="text-align: left;margin-right:1px !important; margin-left:-25px !important;">
                      <a href="$Link" ><img style="text-align: left;" src="$ProductthumbnailImage.SetRatioSize(100,100).URL"  class="img-fluid" alt=""></a>
                  ...
                  <div id="recipe"  class="col-md-3 col-sm-12" style="margin-right:1px !important; margin-left:40px !important;">
                      ...
                      <a> <img id=""  src="$RecipeLogo.SetRatioSize(100,100).URL"  img-fluid" alt=""></a>
