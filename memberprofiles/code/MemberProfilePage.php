...
class MemberProfilePage extends Page implements PermissionProvider {
	...
	private static $defaults = array (
		...
		'AfterRegistrationContent' => '<div class="container"><p class="row  text-uppercase text-center justify-content-center py-12 cbl">Thank you for registering!</p></div>',
	...
	public function getCMSFields() {
        ...
        $fields->addFieldToTab(
                ...
                $uploadField = new UploadField(
                    ...
                    $title = 'Upload files for customer to download(max 10 in total)'
                )   
            );
...
class MemberProfilePage_Controller extends Page_Controller {
	...
	protected function getProfileFields($context) {
		...
		foreach($profileFields as $profileField) {
			...
			$field->setAttribute('placeholder', $profileField->Title);
